...
/*   Updated: 2022/08/05 00:25:54 by lpaulo-m         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include <monitoring.h>

static char	*get_header_tokens(t_http *h)
{
	char	*first_line_end;

	first_line_end = ft_strnstr(h->req->response.ptr, HTTP_DELIMITER,
